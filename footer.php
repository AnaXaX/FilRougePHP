        	...
        	<div class="col-md-4 footer-nav animated fadeInUp">
            	...
            	<div class="col-md-6">
                    <ul class="list">
                        ...
                        <li><a href="nousContacter.php">Contacts</a></li>
        	...
        	<div class="col-md-3 footer-ns animated fadeInRight">
                ...
                <p>
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Vous chercher... ? ">
...
<!-- Bootstrap core JavaScript
    ...
    <script src="js/bootstrap-autohide-navbar.min.js"></script>
   ...
   <!-- <embed src="/fonts/mp3/2.mp3" autostart="true" loop="false" hidden="true"> -->
